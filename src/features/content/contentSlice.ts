    ...
    try {
      ...
      try {
        ...
        const contentsWithRating = data.map((content) => {
          ...
          const avgRating =
            relatedComments.reduce((sum, c) => sum + c.rating, 0) /
        ...
        console.warn(
          "Comment API 호출 실패 (overallRating 계산 스킵):",
          commentError,
        );
        return data;
      }
      ...
      const tempData: ContentCardType[] = [
        ...
        },
        {
          ...
          genre: "액션",
          synopsis:
            "2025년 대한민국, 더 화끈하게! 액션과 스릴이 가득한 새로운 영화가 등장한다. 예측 불가능한 스토리와 강렬한 액션으로 관객들을 사로잡을 것이다.",
          overallRating: 4.0,
        ...
        },
        {
          ...
          genre: "정치",
          synopsis:
            "정치적 갈등과 권력의 암투가 펼쳐지는 드라마. 현실적인 정치 상황을 그려내며 시청자들에게 깊은 여운을 남기는 작품이다.",
          overallRating: 4.8,
        ...
        },
        {
          ...
          genre: "판타지",
          synopsis:
            "아스가르드의 천둥의 신 토르가 지구로 추방되어 인간 세계에서 신으로서의 긍지와 능력을 다시 찾아가는 과정을 그린 판타지 액션.",
          overallRating: 4.0,
          imageUrl:
            "https://image.tmdb.org/t/p/w500/prSfAi1xGrhLQNxVSUFh61xQ4Qy.jpg",
        ...
        },
        {
          ...
          genre: "액션",
          synopsis:
            "아이언맨, 토르, 헐크, 캡틴 아메리카 등의 히어로들이 뭉쳐 세계를 구하기 위해 맞서는 역대급 액션 블록버스터.",
          overallRating: 4.0,
        ...
        },
        {
          ...
          genre: "스릴러",
          synopsis:
            "15년간 감금된 오대수가 풀려난 후 복수를 위해 자신을 가둔 자를 찾아가는 강렬한 복수 스릴러.",
          overallRating: 4.7,
        ...
        },
        {
          ...
          genre: "SF",
          synopsis:
            "컴퓨터 프로그래머 네오가 현실이 사실은 컴퓨터 시뮬레이션 매트릭스라는 것을 깨닫고 인간을 구하기 위해 싸우는 SF 액션.",
          overallRating: 4.8,
        ...
        },
        {
          ...
          genre: "드라마",
          synopsis:
            "1920년대 재즈 시대를 배경으로 한 부와 사랑, 허영심을 그린 F. 스콧 피츠제럴드의 소설 원작 영화.",
          overallRating: 4.2,
        ...
        },
        {
          ...
          genre: "뮤지컬",
          synopsis:
            "할리우드에서 배우와 음악가를 꿈꾸는 젊은 남녀의 사랑과 성공을 그린 뮤지컬 영화.",
          overallRating: 4.6,
        ...
        },
        {
          ...
          genre: "액션",
          synopsis:
            "2004년 서울 용산구에서 벌어진 중국 조폭 조직과 한국 경찰 간의 실화를 바탕으로 한 액션 영화.",
          overallRating: 4.3,
        ...
        },
        {
          ...
          genre: "판타지",
          synopsis:
            "마법사가 된 해리 포터가 호그와트 마법학교에서 친구들과 함께 어둠의 마법사 볼드모트와 맞서는 판타지 영화.",
          overallRating: 4.4,
        ...
        },
        {
          ...
          genre: "SF",
          synopsis:
            "외계 로봇 오토봇과 디셉티콘의 전쟁에 휘말린 소년 샘의 이야기를 그린 SF 액션 블록버스터.",
          overallRating: 4.1,
        ...
        },
        {
          ...
          genre: "좀비",
          synopsis:
            "좀비 바이러스가 퍼진 가운데 부산행 KTX 열차에 탑승한 승객들이 살아남기 위해 싸우는 재난 스릴러.",
          overallRating: 4.5,
        ...
        },
        {
          ...
          genre: "로맨스",
          synopsis:
            "시간 여행 능력을 가진 남자가 사랑하는 여자를 만나기 위해 시간을 되돌리는 로맨틱 코미디.",
          overallRating: 4.3,
        ...
        },
        {
          ...
          genre: "액션",
          synopsis:
            "타노스의 스냅으로 사라진 절반의 생명체를 되돌리기 위해 어벤져스가 과거로 돌아가 싸우는 마블 시네마틱 유니버스의 대단원.",
          overallRating: 4.7,
        ...
        },
        {
          ...
          genre: "드라마",
          synopsis:
            "무죄임에도 불구하고 쇼생크 교도소에 갇힌 앤디가 20년간의 수감 생활 끝에 탈출을 시도하는 감동적인 드라마.",
          overallRating: 4.9,
        ...
        },
        {
          ...
          genre: "SF",
          synopsis:
            "우주 임무 중 우주선이 파괴되어 고립된 우주비행사가 지구로 돌아오기 위해 생존을 시도하는 SF 스릴러.",
          overallRating: 4.4,
        ...
        },
        {
          ...
          genre: "범죄",
          synopsis:
            "1980년대 부산에서 세관 공무원 출신이 조직의 보스로 성장하는 과정을 그린 범죄 액션 영화.",
          overallRating: 4.6,
        ...
        },
        {
          ...
          genre: "판타지",
          synopsis:
            "주인공 앤디의 장난감들이 살아있는 것처럼 움직이며 벌어지는 모험을 그린 픽사 애니메이션 영화.",
          overallRating: 4.5,
        ...
        },
        {
          ...
          genre: "SF",
          synopsis:
            "지구에 거주하는 외계인을 감시하고 관리하는 비밀 기관의 요원들이 외계인 범죄를 막는 SF 코미디 액션.",
          overallRating: 4.2,
        ...
        },
        {
          ...
          genre: "코미디",
          synopsis:
            "마약 조직을 잡기 위해 치킨집을 운영하며 수사하던 형사들이 의도치 않게 치킨집이 대박나면서 벌어지는 코미디.",
          overallRating: 4.4,
        ...
        },
        {
          ...
          genre: "SF",
          synopsis:
            "쓰레기로 뒤덮인 지구에서 마지막 남은 로봇 월-E가 우주선에 탑승한 이브를 만나 인류를 구하는 SF 애니메이션.",
          overallRating: 4.6,
        ...
        },
        {
          ...
          genre: "판타지",
          synopsis:
            "사후 세계에서 7개의 지옥 재판을 받는 화재 구조원의 이야기를 그린 판타지 영화.",
          overallRating: 4.3,
        ...
        },
        {
          ...
          genre: "액션",
          synopsis:
            "프로페셔널 킬러 레옹이 가족이 모두 살해당한 12세 소녀 마틸다를 구하고 자신의 복수를 도와달라는 그녀의 요청을 받아들이는 액션 드라마.",
          overallRating: 4.7,
