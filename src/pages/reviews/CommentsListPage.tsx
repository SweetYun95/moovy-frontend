// moovy-frontend/src/pages/reviews/CommentsListPage.tsx
// 외부 라이브러리
      ...
      <div className="container py-4">
         <div className="comments-list-page">
            <div className="comments-list-page__header mb-4">
               <h2 className="comments-list-page__title">{getCommentListTitle(topic?.title, sortBy, sortedComments.length)}</h2>
            </div>
               ...
               <>
                  <div className={`row ${contentId ? 'comments-list-page__list-layout' : 'comments-list-page__grid-layout'}`}>
                     {paginatedComments.map((c: CommentCardType) => {
                        ...
                        return (
                           <div key={c.id} className={contentId ? 'col-12 col-sm-6 col-lg-4 col-xl-3 mb-4' : 'col-12 col-sm-6 col-lg-4 mb-4'}>
                              <ImageCommentCard
                                 username={c.username}
