               ...
               <div className="col-12">
                  <section className="settings-modal__section">
                     ...
                     <div className="settings-modal__item">
                        ...
                        <Toggle checked={settings.kakaoNotifications} onChange={() => handleToggle('kakaoNotifications')} />
                     </div>

                     <div className="settings-modal__item">
                        <span className="settings-modal__item-label">웹 push</span>
                        <Toggle checked={settings.webPushNotifications} onChange={() => handleToggle('webPushNotifications')} />
                     </div>
                  </section>
               </div>
            </div>
               ...
               <div className="col-12">
                  <section className="settings-modal__section">
                     ...
                     <div className="settings-modal__item">
                        ...
                        <Toggle checked={settings.showActivity} onChange={() => handleToggle('showActivity')} />
                     </div>
                  </section>
               </div>
            </div>
               ...
               <div className="col-12">
                  <section className="settings-modal__section">
                     ...
                     <div className="settings-modal__item">
                        ...
                        <Toggle checked={settings.kakaoLinked} onChange={() => handleToggle('kakaoLinked')} />
                     </div>

                     <div className="settings-modal__item">
                        <span className="settings-modal__item-label">구글</span>
                        <Toggle checked={settings.googleLinked} onChange={() => handleToggle('googleLinked')} />
                     </div>
                  </section>
               </div>
            </div>
               ...
               <div className="col-12">
                  <section className="settings-modal__section">
                     ...
                     <div className="settings-modal__item">
                        ...
                        <select className="settings-modal__select" onChange={(e) => onLanguageChange?.(e.target.value)}>
                     ...
                     {onWithdraw && (
                        <div className="settings-modal__item">
                           <span className="settings-modal__item-label settings-modal__item-label--danger" onClick={onWithdraw}>
                              탈퇴하기
                           </span>
                        </div>
                     )}
...
export function SettingsModalComponent({ isOpen, onClose }: { isOpen: boolean; onClose: () => void }) {
   ...
   return <SettingsModal isOpen={isOpen} onClose={onClose} initialSettings={settings} onLanguageChange={handleLanguageChange} onWithdraw={handleWithdraw} onToggle={handleToggle} />
}
