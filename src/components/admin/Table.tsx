...
import { ReportManagementFilter, UserManagementFilter, WorkManagementFilter } from './AdminFilter'
            ...
            <>
               <div className="admin-content">
                  ...
                  <div className={`table ${content}-table`}>
                     ...
                     {content === 'user' && <UserTable columns={columns} content={content} filters={appliedUserFilters} />}
                     {content === 'topic' && <TopicTable columns={columns} content={content} />}
                     {content === 'inquiry' && <InquiryTable columns={columns} content={content} />}
                     {content === 'report' && <ReportTable columns={columns} content={content} />}
                  </div>
