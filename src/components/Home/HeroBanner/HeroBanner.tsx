...
import { buildHeroSlides, type SliderSection, type HeroSlide } from '@/utils/homeSections'
   ...
   return (
      <div className="hero-banner border-0 overflow-hidden">
         <div className="hero-banner__wrapper">
            <button id={prevBtnId} className="hero-banner__nav-button hero-banner__nav-button--prev" aria-label="이전 슬라이드">
                  ...
                  return (
                     <SwiperSlide key={idx}>
                        <div className="hero-banner__slide">
                           <div className="hero-banner__image" style={{ backgroundImage: `url(${s.imageUrl})` }} />
            ...
            <button id={nextBtnId} className="hero-banner__nav-button hero-banner__nav-button--next" aria-label="다음 슬라이드">
