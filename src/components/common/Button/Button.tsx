...
export const LoginButton: React.FC<LoginButtonProps> = ({ loginType, text, children, ...rest }) => {
...
export const StatusButton: React.FC<StatusButtonProps> = ({ status, text, children, ...rest }) => {
   let variant: ButtonProps['variant']
   let defaultText: string
...
export const ActionButton: React.FC<ActionButtonProps> = ({ action, text, children, ...rest }) => {
   let variant: ButtonProps['variant']
   let defaultText: string
...
export const WideButton: React.FC<WideButtonProps> = ({ buttonType, text, children, ...rest }) => {
